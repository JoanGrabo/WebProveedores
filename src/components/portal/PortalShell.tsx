      ...
      >
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto p-3">
          ...
          <NavItem
            href="/comandas"
            label="Comandas"
            active={pathname?.startsWith("/comandas") && pathname !== "/comandas/ayuda"}
            icon={
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
          ...
          {me?.rol === "PROVEEDOR" && (
            <NavItem
              href="/comandas/ayuda"
              label="Ayuda comandas"
              active={pathname === "/comandas/ayuda"}
              icon={
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                  <path
                    strokeLinecap="round"
          ...
          {isAdmin && (
            <NavItem
              href="/admin/entradas"
              label="Entradas"
              active={pathname === "/admin/entradas" || (pathname?.startsWith("/admin/entradas/") ?? false)}
              icon={
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                  <path
                    strokeLinecap="round"
